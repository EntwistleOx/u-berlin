            ...
            <Col md={12}>
              <div className="text-justify">
                <p>
                  ...
                  como por ejemplo: vehículos y motocicletas usadas, asbesto en
                  cualquiera de sus formas, pornografía, desechos industriales
                  tóxicos, entre otras.
                </p>

                <p>
                  En ocasiones, el producto a importar, por su naturaleza, puede
                  estar sujeto a visto bueno, autorización o control por parte
                  de algún servicio fiscalizador, por lo que es necesario
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        alguna, cualquiera que sea la persona, establecimiento o
                        entidad que efectúe la operación.
                      </td>
                      <td>Dirección General de Movilización Nacional</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>
                        Productos vegetales y mercancías que tengan el carácter
                        de peligrosas para los vegetales.
                      </td>
                      <td>Servicio Agrícola y Ganadero</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>
                        Productos o subproductos alimenticios de origen animal o
                        vegetal.
                      </td>
                      <td>Servicio Agrícola y Ganadero</td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        Productos farmacéuticos o alimenticios de uso médico y/o
                        cosmético
                      </td>
                      <td>Servicio de Salud</td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        ...
                        acumuladores; desechos de cinc, de plomo, de antimonio,
                        berilio, cadmio, cromo, de productos farmacéuticos, de
                    ...
                    <tr>
                      <td>
                        La importación de cementos susceptibles de ser empleados
                        en la confección de elementos de resistencia de obras
                        públicas y edificios.
                      </td>
                      <td>
                        Previo a su desaduanamiento deben presentar Certificado
                        de Calidad, emitido por un Laboratorio de Control
                        Técnico de Calidad de Construcción, inscrito en el
                        Registro oficial de Laboratorios de Control Técnico de
                        Calidad de Construcción del Ministerio de Vivienda y
                        Urbanismo.
                      </td>
                    </tr>
                  </tbody>
                ...
                <ul>
                  <li>
                    ...
                    usados (sin perjuicio de las franquicias establecidas en la
                    normas vigentes).
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Motos usadas.
                  </li>
                  <li>
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Mercancías que
                    sean peligrosas para los animales, para la agricultura o la
                    salud humana (por ejemplo; algunos plaguicidas de uso
                    agrícola, juguetes y artículos de uso infantil que contengan
                    tolueno, adhesivos fabricados en base a solventes
                    volátiles), las que se encuentran prohibidas por Decreto del
                    Ministerio de Salud, del Ministerio de Agricultura y otros
                ...
                <p>
                  ...
                  los viajeros y se acojan a la Partida 009, hasta por un valor
                  de US$ 3.000 FOB, y para las mercancías con carácter
                ...
                <ul>
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Poder notarial
                    del dueño o consignatario para un despacho determinado, en
                    los casos en que la persona que trámite sea un tercero.
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Vistos Buenos
                    o Certificaciones si son necesarias.
                  </li>
                </ul>

                <p>
                  Si el valor de la mercancía supera los US$1.000 valor FOB: el
                  importador debe contratar un agente de aduanas.
                </p>

                <p>
                  Respecto de los documentos de base, es necesario precisar, que
                  existen algunos que son obligatorios para toda importación con
                  carácter comercial, y otros documentos que se requieren sólo
                ...
                <ul>
                  ...
                  <li>
                    ...
                    constituido por el sólo endoso del original del conocimiento
                    de embarque.
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Certificado de
                    Origen , en caso que la importación se acoja a alguna
                    preferencia arancelaria, en virtud de un Acuerdo Comercial.
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Lista de
                    empaque, cuando proceda, correspondiendo siempre en caso de
                    mercancías acondicionadas en contenedores.
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Certificado de
                    seguros, cuando el valor de la prima no se encuentre
                  ...
                  <li>
                    ...
                    visaciones, certificaciones o vistos buenos, cuando proceda.
                  </li>
                </ul>

                <p>
                  Por regla general, las importaciones están afectas al pago del
                  derecho ad valorem (6%) sobre su valor CIF (costo de la
                ...
                <ul>
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> TOTAL TRIBUTOS
                    ADUANEROS US $ 261,40
                  </li>
                </ul>
                ...
                <p>
                  ...
                  establecen (por ejemplo: trigo y azúcar). En los casos en que
                  se autoriza su importación, las mercancías usadas pagan un
                  recargo adicional del 3% sobre su valor CIF, además de los
                ...
                <ul>
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Joyas, piedras
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Pieles finas,
                  ...
                  <li>
                    <FontAwesomeIcon icon={faAngleDoubleRight} /> Armas de aire
                ...
                <p>
                  ...
                  tales como fuegos artificiales, petardos y similares, excepto
                  los de uso industrial, minero o agrícola o de señalización
                  luminosa.
                </p>
                ...
                <table className="table table-striped table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Cigarrillos</td>
                      <td>
                        Impuesto Específico de 0,0010304240 UTM por cigarrillo,
                        y un impuesto de 30% sobre el precio de venta
                        consumidor, incluido impuestos, por paquete, cajas o
                        envoltorios
                      </td>
                    </tr>
                    <tr>
                ...
                <p>
                  La importación de las máquinas y aparatos para el tratamiento
                  o procesamiento de datos, se encuentra libre de derechos de
                  aduana por aplicación de la cláusula de la nación más
                  favorecida, siendo irrelevante el origen o procedencia de la
                  mercancía.
                </p>

                <p>
                  De esta forma, los computadores sólo pagan el IVA (19%). En el
                  caso de los computadores usados procedentes de USA y Corea no
                  pagan el recargo por uso; sólo pagan el IVA sobre el valor
                  CIF.
                </p>
