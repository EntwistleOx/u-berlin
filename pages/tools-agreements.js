              ...
              <Col lg={6}>
                <div className="text-justify p-2 ">
                  <p>
                    ...
                    acceso a los principales mercados en el mundo, alcanzando
                    más de 4200 millones de personas distribuidas en los cinco
                    continentes.{' '}
                  </p>
                  ...
                  <p>
                    ...
                    la Asociación Latinoamericana de Integración (ALADI). Chile
                    ha suscrito ACE con Venezuela (firmado en 1993), Bolivia
                    (firmado en 1993), Ecuador (firmado en 1994), y en 1996 con
                    el Mercado Común del Sur (Mercosur), cuyos miembros son
                    Argentina, Brasil, Paraguay y Uruguay. Por otro lado, los
                    acuerdos de alcance parcial se refieren a medidas
                    arancelarias para denominados productos, y se considera una
                    primera etapa para un tratado de mayor alcance; Chile tiene
                    acuerdos de este tipo con Cuba (firmado en 1999 y ratificado
                    en 2008) e India (firmado en 2006 y ratificado en 2007).
                  </p>
                </div>
              </Col>
            </Row>
              ...
              <Col md={12} className="text-justify mt-4">
                <table className="table table-striped table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        Unión Europea <span style={{ display: 'none' }}></span>
                        (5)
                      </td>
                ...
                <ul>
                  <li>
                    ...
                    Centroamérica: Costa Rica, El Salvador, Guatemala, Honduras
                    y Nicaragua.
                  </li>
                  <li>
